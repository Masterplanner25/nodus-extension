...
> **Coordinated launch:** nodus-extension v0.1.0 is prepared but not published.
> Publication follows the three-artifact set (nodus-lang 4.0.0 + nodus-mcp 0.1.0 +
> nodus-a2a 0.1.0) and subsequent nodus-memory 0.1.0.
